...
## Project Structure
    ...
    ├── mute_snowflake_28933  # Django project configurations
...
1. Clone this repo and `cd mute_snowflake_28933`
...
2. Clone this repo and `cd mute_snowflake_28933`
